...
int PlayerStats::GetPlayerSpeed() const {return player_speed_;}
void PlayerStats::SetBulletRange(float range) {bullet_range_ = range;}
int PlayerStats::GetBulletRange() const {return bullet_range_;}
void PlayerStats::SetBulletSpeed(float bullet_speed) {bullet_speed_ = bullet_speed;}
int PlayerStats::GetBulletSpeed() const {return bullet_speed_;}
